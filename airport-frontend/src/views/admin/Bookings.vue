...
<template>
  <div>
    ...
    <div class="card filter-card">
      <div class="filter-grid-4">
        <input v-model="searchQuery" @input="handleSearch" type="text" placeholder="Search by reference or passenger..."
          class="form-control" />
        <select v-model="classFilter" @change="handleSearch" class="form-control">
          <option value="">All Classes</option>
          <option value="economy">Economy</option>
          <option value="business">Business</option>
          <option value="first">First Class</option>
        </select>
        <select v-model="statusFilter" @change="handleSearch" class="form-control">
          <option value="">All Status</option>
          <option value="confirmed">Confirmed</option>
          <option value="pending">Pending</option>
          <option value="cancelled">Cancelled</option>
        </select>
        <input v-model="dateFilter" @change="handleSearch" type="date" class="form-control" />
      </div>
    </div>
      ...
      <div class="modal-content modal-large">
        ...
        <form @submit.prevent="handleSubmit">
          <div class="form-grid">
            ...
            <div class="form-group">
              <label class="form-label">Seat Number</label>
              <input v-model="form.seat_number" type="text" class="form-control" placeholder="e.g., 12A"
                @input="form.seat_number = form.seat_number ? form.seat_number.toUpperCase() : ''" />
            </div>

            <div class="form-group">
              <label class="form-label">Booking Date *</label>
              <input v-model="form.booking_date" type="datetime-local" class="form-control" required />
            </div>

            <div class="form-group">
              <label class="form-label">Total Price *</label>
              <input v-model.number="form.total_price" type="number" step="0.01" min="0" class="form-control"
                required />
            </div>
